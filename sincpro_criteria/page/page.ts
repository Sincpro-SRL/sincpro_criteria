/**
 * What a paginated answer carries besides its records.
 *
 ...
 *
 * These types are written by hand rather than generated for a concrete reason: the engine
 * serialises this envelope through a custom serializer, which is invisible to the JSON Schema
 * the OpenAPI document is built from — there it comes out as `{[key: string]: unknown}`.
